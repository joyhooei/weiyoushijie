class Character {
    ...
    static createAll(): Character[] {
        ...
        let config = [
            ...
            {name: 'BombSoldier1',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'BombSoldier2',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'BombSoldier3',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'BombSoldier4',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'BombSoldier5',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'ArrowSoldier1',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'ArrowSoldier2',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'ArrowSoldier3',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'ArrowSoldier4',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},
            {name: 'ArrowSoldier5',  properties:{hp:245, force:6, armor: 0, cureSpeed:1, moveSpeed:1, guardRadius: 40}},            
