class Character {
    ...
    static createAll(): Character[] {
        ...
        let config = [
            ...
            {name: 'Enemy10',  properties:{bonus:8, livesTaken: 1, hp:[60, 80, 104], forceHigh:0, forceLow:0, armor: 0, magicArmor: 0, cureSpeed:0, moveSpeed:1, idleTicks:0, dyingTicks:application.frameRate}},
            ...
            {name: 'Enemy12',  properties:{bonus:10, livesTaken: 1, hp:[100, 100, 130], forceHigh:8, forceLow:4, armor: 0, magicArmor: 0, cureSpeed:0, moveSpeed:1, idleTicks:0, dyingTicks:application.frameRate}},
            ...
            {name: 'Enemy27',  properties:{bonus:10, livesTaken: 1, hp:[70, 100, 130], forceHigh:0, forceLow:0, armor: 0, magicArmor: 0, cureSpeed:0, moveSpeed:1, idleTicks:0, dyingTicks:application.frameRate}},
            {name: 'Enemy28',  properties:{bonus:100, livesTaken: 1, hp:[300, 500, 650], forceHigh:0, forceLow:0, armor: 0, magicArmor: 0, cureSpeed:0, moveSpeed:1, idleTicks:0, dyingTicks:application.frameRate}},
