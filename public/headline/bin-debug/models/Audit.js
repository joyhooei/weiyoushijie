var Audit = (function () {
    ...
    var d = __define,c=Audit,p=c.prototype;
    Audit.claim = function (audit) {
        audit.claimed = 1;
        return application.dao.save("Audit", audit);
    };
    Audit.hasRewards = function (audits) {
...
egret.registerClass(Audit,'Audit');
