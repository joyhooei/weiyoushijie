class Project {
	...
	static addProjectLevelRatio(project: Project, projectLevel: number) {
		var data = [
			...
			[[3000, 3499], 	[1, 9 , 1.01, 1.005],	[10, 20, 1.03, 1.005]],
			[[3500, 3999], 	[1, 9 , 1.01, 1.005],	[10, 20, 1.03, 1.005]],
			
			[[4000, 4499], 	[1, 13, 1.01, 1.005],	[14, 20, 1.03, 1.005]],
			[[4500, 4999], 	[1, 13, 1.01, 1.005],	[14, 20, 1.03, 1.005]],
			
			[[5000, 5999], 	[1, 17, 1.03, 1.005],	[18, 18, 1.04, 1.005],	[19, 20, 1.05, 1.005]],
			
			[[6000, 6999], 	[1, 17, 1.03, 1.005],	[18, 18, 1.04, 1.005],	[19, 20, 1.05, 1.005]],
			
			[[7000, 7999], 	[1, 17, 1.03, 1.005],	[18, 18, 1.04, 1.005],	[19, 20, 1.05, 1.005]],
