class AuctionUI extends eui.Component{
    ...
    private uiCompHandler():void {
        ...
        this.btnHelp.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function() {
			...
			content += "6： 每天（当天中午12点到次日中午12点）首次参加拍卖可以在礼物页面中领取100钻石奖励。\n";
			content += "7： 截止每天晚上12点，排名榜玩家获得奖励。\n";
			content += "7.1： 第1名 2000钻。\n";
			content += "7.2： 第2名 1500钻。\n";
			content += "7.3： 第3名 1200钻。\n";
			content += "7.4： 第4名到第10名 1000钻。\n";
			content += "7.5： 第11名到第100名 500钻。\n";
